...
{
    public function list(EducationProcessModel $educationProcessModel,User $user,Request $request)
    {
    ...
    public function list_org(EducationProcessModel $educationProcessModel,Request $request)
    {
